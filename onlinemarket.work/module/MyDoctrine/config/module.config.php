...
return [
    ...
    'doctrine' => [
        'driver' => [
            //*** DOCTRINE LAB: define an annotation driver and names it `doctrine_annotation_driver`
            // default metadata driver, aggregates all other drivers into a single one.
            // Override `orm_default` only if you know what you're doing
            'orm_default' => [
                'drivers' => [
                    //*** DOCTRINE LAB: register `doctrine_annotation_driver` for any entity under namespace `MyDoctrine\Entity`
                ]
            ],
        ],
