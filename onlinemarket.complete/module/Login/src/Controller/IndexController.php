    ...
    public function loginAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if (!$this->loginForm->isValid()) {
                ...
                //*** SECURITY::LDAP LAB: trigger an event here and pass $adapter as a parameter
                ...
                if ($result->isValid()) {
                    ...
                    //*** SECURITY::AUTHENTICATION LAB: get storage and the result row object
                    ...
                    //*** SECURITY::AUTHENTICATION LAB: write Login\Model\User instance to storage
